...
This baseline analysis for 7 and 8 TeV reported an expected limit of $5.1^{+2.3}_{-1.5}$ times the standard model
and an observed limit of 7.4 times the standard model \cite{hmumuPap}. It is projected that, at 14 TeV, 
...
The idea of using jet and dimuon $p_{T}$s lead us to another very similar cut that selects against $t\overline{t}$ 
